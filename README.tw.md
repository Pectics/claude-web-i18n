...
<img src="showcase-1.png" width="720" alt="使用前後對比" />

<img src="showcase-2.png" width="720" alt="完整中文化介面" />
...
1. 在 [`locales.json`](locales.json) 中新增 locale 條目（如 `{"locale": "zh-TW", "name": "繁體中文 (台灣)"}`)
